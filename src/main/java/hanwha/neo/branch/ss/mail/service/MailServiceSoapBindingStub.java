...
public class MailServiceSoapBindingStub extends org.apache.axis.client.Stub implements hanwha.neo.branch.ss.mail.service.MailService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://service.mail.ss.branch.neo.hanwha", "WsMailStatus"));
        oper.setReturnClass(hanwha.neo.branch.ss.mail.service.WsMailStatus[].class);
    ...
    public MailServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://service.mail.ss.branch.neo.hanwha", "WsMailInfo");
            cachedSerQNames.add(qName);
            cls = hanwha.neo.branch.ss.mail.service.WsMailInfo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://service.mail.ss.branch.neo.hanwha", "WsMailStatus");
            cachedSerQNames.add(qName);
            cls = hanwha.neo.branch.ss.mail.service.WsMailStatus.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://service.mail.ss.branch.neo.hanwha", "WsRecipient");
            cachedSerQNames.add(qName);
            cls = hanwha.neo.branch.ss.mail.service.WsRecipient.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://service.mail.ss.branch.neo.hanwha", "WsResource");
            cachedSerQNames.add(qName);
            cls = hanwha.neo.branch.ss.mail.service.WsResource.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {mailKey});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (hanwha.neo.branch.ss.mail.service.WsMailStatus[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (hanwha.neo.branch.ss.mail.service.WsMailStatus[]) org.apache.axis.utils.JavaUtils.convert(_resp, hanwha.neo.branch.ss.mail.service.WsMailStatus[].class);
            }
        }
