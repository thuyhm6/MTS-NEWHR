...
ở trong file C:\apache-tomcat-10.1.55\bin\setenv.bat tôi đã thiết lập @echo off
...
Căn cứ vào ManageEmpPositionInfoList.html, hãy tạo cho tôi file ManageCountInfoList.html - Thống kê nhân viên nằm trong module ess/viewDept. Giao diện sẽ hiển thị các thống kê về nhân viên trong phòng ban mà người quản lý đó đang quản lý, bao gồm các thông tin như tổng số nhân viên, số nhân viên theo từng phòng ban - DEPTNO, số nhân viên theo từng Nhóm nhân viên - POST_FAMILY, số nhân viên theo từng chức vụ - POST_GRADE_NO, số nhân viên theo từng Loại nhân viên - EMP_TYPE_CODE, số nhân viên theo từng độ tuổi (ngày sinh lấy từ trường DOB (định dạng hiện tại là DD/MM/YYYY) của bảng hr_personal_info), số nhân viên theo từng giới tính (lấy từ trường SEXCODE của bảng hr_personal_info),... Dữ liệu sẽ được lấy từ bảng HR_EMPLOYEE kết hợp với các bảng liên quan khác như HR_DEPARTMENT, hr_personal_info,... để lấy ra những thông tin cần thiết cho việc thống kê. Giao diện sẽ có các biểu đồ trực quan để hiển thị các thống kê đó một cách dễ hiểu và sinh động hơn. Việc này sẽ giúp cho người quản lý có cái nhìn tổng quan về tình hình nhân sự trong phòng ban của mình để có thể đưa ra những quyết định phù hợp trong việc quản lý và phát triển nguồn nhân lực. bên dưới các thông kê biểu đồ là danh sách chi tiết về nhân viên trong phòng ban đó với các thông tin cơ bản như Mã nhân viên, Tên nhân viên, Phòng ban, Chức vụ, Nhóm nhân viên, Loại nhân viên, Ngày sinh, Giới tính,... để người quản lý có thể xem và theo dõi thông tin của từng nhân viên một cách cụ thể hơn. Việc này sẽ giúp cho người quản lý có thể nắm bắt được tình hình nhân sự trong phòng ban của mình một cách chi tiết và chính xác hơn để có thể đưa ra những quyết định phù hợp trong việc quản lý và phát triển nguồn nhân lực.


Ở đây khi Lưu - savePersonal thì không thực hiển việc sửa trực tiếp vào bảng hr_personal_info, mà sẽ thêm vào bảng HR_PERSONAL_INFO_APPLY với các trường thm khảo từ hình ảnh. Khi thêm mới thì ACTIVITY = 1. Thêm cho tôi chức năng upload file đính kèm. Nếu có upload thì sẽ lưu file đó vào thư mục đính kèm (D:\source\VHR\HTSV_HR\resources\fileUpload\) và lưu đường dẫn của các file đó vào bảng ess_file, với các trường tham khảo từ hình ảnh, 2 bảng HR_PERSONAL_INFO_APPLY và ess_file sẽ liên kết với nhau thông qua trường APPLY_NO để lấy ra thông tin về file đính kèm của từng nhân viên. Khi người quản lý duyệt thông tin cá nhân của nhân viên đó thì sẽ hiển thị ra những file đính kèm mà nhân viên đó đã upload lên để người quản lý có thể xem xét và đưa ra quyết định duyệt hay không duyệt thông tin cá nhân đó. Việc này sẽ giúp cho quá trình quản lý thông tin cá nhân của nhân viên được minh bạch hơn và có đầy đủ căn cứ để đưa ra quyết định duyệt hay không duyệt thông tin cá nhân đó.

Khi Lưu - savePersonal hãy loại bỏ APPLY_NO của bảng HR_PERSONAL_INFO_APPLY. khi thêm mới thì trường PERSON_NO sẽ sinh ra dựa vào HR_PERSONAL_INFO_APPLY_SEQ.NEXTVAL. và trường PERSON_NO này sẽ liên kết với trường APPLY_NO của bảng ess_file để lấy ra thông tin về file đính kèm của từng nhân viên. khi thêm mới ở bảng ess_file thì trường FILE_NO sẽ được sinh ra dựa vào ESS_FILE_SEQ.NEXTVAL. Trường APPLY_NO sẽ lấy giá trị từ trường PERSON_NO của bảng HR_PERSONAL_INFO_APPLY để liên kết với bảng HR_PERSONAL_INFO_APPLY.

Tương tự như chức năng Lưu - savePersonal của viewPersonalInfoForEss.html, thì khi Lưu thoogn tin địa chỉ - saveAddress thì cũng thêm vào bảng hr_address_matters_apply với các trường tham khảo từ hình ảnh. Khi thêm mới thì ACTIVITY = 1, trường ADDRESS_NO tăng lên dựa vào HR_ADDRESS_MATTERS_apply_SEQ.NEXTVAL. Và cũng có chức năng upload file đính kèm giống như khi lưu thông tin cá nhân, nếu có upload thì sẽ lưu file đó vào thư mục đính kèm (D:\source\VHR\HTSV_HR\resources\fileUpload\) và lưu đường dẫn của các file đó vào bảng ess_file, 2 bảng hr_address_matters_apply và ess_file sẽ liên kết với nhau thông qua trường APPLY_NO để lấy ra thông tin về file đính kèm của từng nhân viên. Khi người quản lý duyệt thông tin địa chỉ của nhân viên đó thì sẽ hiển thị ra những file đính kèm mà nhân viên đó đã upload lên để người quản lý có thể xem xét và đưa ra quyết định duyệt hay không duyệt thông tin địa chỉ đó. Việc này sẽ giúp cho quá trình quản lý thông tin địa chỉ của nhân viên được minh bạch hơn và có đầy đủ căn cứ để đưa ra quyết định duyệt hay không duyệt thông tin địa chỉ đó.

Khi Lưu - saveAddress hãy loại bỏ APPLY_NO của bảng hr_address_matters_apply.và trường ADDRESS_NO của bảng hr_address_matters_apply này sẽ liên kết với trường APPLY_NO của bảng ess_file để lấy ra thông tin về file đính kèm của từng nhân viên. khi thêm mới ở bảng ess_file thì trường FILE_NO sẽ được sinh ra dựa vào ESS_FILE_SEQ.NEXTVAL. Trường APPLY_NO sẽ lấy giá trị từ trường ADDRESS_NO của bảng hr_address_matters_apply để liên kết với bảng hr_address_matters_apply.

Tương tự như chức năng Lưu - savePersonal của viewPersonalInfoForEss.html, thì khi Lưu thông tin gia đình - saveFamily thì cũng thêm vào bảng HR_FAMILY_APPLY với các trường tham khảo từ hình ảnh. Khi thêm mới thì ACTIVITY = 1, trường FAMILY_NO tăng lên dựa vào HR_FAMILY_SEQ_APPLY.NEXTVAL. Và cũng có chức năng upload file đính kèm giống như khi lưu thông tin cá nhân, nếu có upload thì sẽ lưu file đó vào thư mục đính kèm (D:\source\VHR\HTSV_HR\resources\fileUpload\) và lưu đường dẫn của các file đó vào bảng ess_file, 2 bảng HR_FAMILY_APPLY và ess_file sẽ liên kết với nhau thông qua trường APPLY_NO để lấy ra thông tin về file đính kèm của từng nhân viên. Khi người quản lý duyệt thông tin gia đình của nhân viên đó thì sẽ hiển thị ra những file đính kèm mà nhân viên đó đã upload lên để người quản lý có thể xem xét và đưa ra quyết định duyệt hay không duyệt thông tin gia đình đó. Việc này sẽ giúp cho quá trình quản lý thông tin gia đình của nhân viên được minh bạch hơn và có đầy đủ căn cứ để đưa ra quyết định duyệt hay không duyệt thông tin gia đình đó.

Khi Lưu - saveFamily hãy loại bỏ APPLY_NO của bảng HR_FAMILY_APPLY.và trường FAMILY_NO của bảng HR_FAMILY_APPLY này sẽ liên kết với trường APPLY_NO của bảng ess_file để lấy ra thông tin về file đính kèm của từng nhân viên. khi thêm mới ở bảng ess_file thì trường FILE_NO sẽ được sinh ra dựa vào ESS_FILE_SEQ.NEXTVAL. Trường APPLY_NO sẽ lấy giá trị từ trường FAMILY_NO của bảng HR_FAMILY_APPLY để liên kết với bảng HR_FAMILY_APPLY.

Tương tự như chức năng Lưu - savePersonal của viewPersonalInfoForEss.html, thì khi Lưu Người liên hệ khẩn cấp - saveEmergency thì cũng thêm vào bảng hr_emergency_address_apply với các trường tham khảo từ hình ảnh. Khi thêm mới thì ACTIVITY = 1, trường EMERGENCY_NO tăng lên dựa vào hr_emergency_address_apply_seq.NEXTVAL. Và cũng có chức năng upload file đính kèm giống như khi lưu thông tin cá nhân, nếu có upload thì sẽ lưu file đó vào thư mục đính kèm (D:\source\VHR\HTSV_HR\resources\fileUpload\) và lưu đường dẫn của các file đó vào bảng ess_file, 2 bảng hr_emergency_address_apply và ess_file sẽ liên kết với nhau thông qua trường APPLY_NO để lấy ra thông tin về file đính kèm của từng nhân viên. Khi người quản lý duyệt thông tin người liên hệ khẩn cấp của nhân viên đó thì sẽ hiển thị ra những file đính kèm mà nhân viên đó đã upload lên để người quản lý có thể xem xét và đưa ra quyết định duyệt hay không duyệt thông tin người liên hệ khẩn cấp đó. Việc này sẽ giúp cho quá trình quản lý thông tin người liên hệ khẩn cấp của nhân viên được minh bạch hơn và có đầy đủ căn cứ để đưa ra quyết định duyệt hay không duyệt thông tin người liên hệ khẩn cấp đó.

Khi Lưu - saveEmergency hãy loại bỏ APPLY_NO của bảng hr_emergency_address_apply.và trường EMERGENCY_NO của bảng hr_emergency_address_apply này sẽ liên kết với trường APPLY_NO của bảng ess_file để lấy ra thông tin về file đính kèm của từng nhân viên. khi thêm mới ở bảng ess_file thì trường FILE_NO sẽ được sinh ra dựa vào ESS_FILE_SEQ.NEXTVAL. Trường APPLY_NO sẽ lấy giá trị từ trường EMERGENCY_NO của bảng hr_emergency_address_apply để liên kết với bảng hr_emergency_address_apply.

Tương tự như chức năng Lưu - savePersonal của viewPersonalInfoForEss.html, thì khi Lưu Kinh nghiệm làm việc - saveWorkExp thì cũng thêm vào bảng HR_WORK_EXPERIENCE_APPLY với các trường tham khảo từ hình ảnh. Khi thêm mới thì ACTIVITY = 1, trường WORK_EXPERIENCE_NO tăng lên dựa vào HR_WORK_EXPERIENCE_APPLY_SEQ.NEXTVAL. Và cũng có chức năng upload file đính kèm giống như khi lưu thông tin cá nhân, nếu có upload thì sẽ lưu file đó vào thư mục đính kèm (D:\source\VHR\HTSV_HR\resources\fileUpload\) và lưu đường dẫn của các file đó vào bảng ess_file, 2 bảng HR_WORK_EXPERIENCE_APPLY và ess_file sẽ liên kết với nhau thông qua trường APPLY_NO để lấy ra thông tin về file đính kèm của từng nhân viên. Khi người quản lý duyệt thông tin kinh nghiệm làm việc của nhân viên đó thì sẽ hiển thị ra những file đính kèm mà nhân viên đó đã upload lên để người quản lý có thể xem xét và đưa ra quyết định duyệt hay không duyệt thông tin kinh nghiệm làm việc đó. Việc này sẽ giúp cho quá trình quản lý thông tin kinh nghiệm làm việc của nhân viên được minh bạch hơn và có đầy đủ căn cứ để đưa ra quyết định duyệt hay không duyệt thông tin kinh nghiệm làm việc đó.

Khi Lưu - saveWorkExp hãy loại bỏ APPLY_NO của bảng HR_WORK_EXPERIENCE_APPLY.và trường WORK_EXPERIENCE_NO của bảng HR_WORK_EXPERIENCE_APPLY này sẽ liên kết với trường APPLY_NO của bảng ess_file để lấy ra thông tin về file đính kèm của từng nhân viên. khi thêm mới ở bảng ess_file thì trường FILE_NO sẽ được sinh ra dựa vào ESS_FILE_SEQ.NEXTVAL. Trường APPLY_NO sẽ lấy giá trị từ trường WORK_EXPERIENCE_NO của bảng HR_WORK_EXPERIENCE_APPLY để liên kết với bảng HR_WORK_EXPERIENCE_APPLY.

Tương tự như chức năng Lưu - savePersonal của viewPersonalInfoForEss.html, thì khi Lưu Trình độ học vấn - saveEduc thì cũng thêm vào bảng HR_EDUCATION_APPLY với các trường tham khảo từ hình ảnh. Khi thêm mới thì ACTIVITY = 1, trường EDUC_NO tăng lên dựa vào HR_EDUCATION_APPLY_SEQ.NEXTVAL. Và cũng có chức năng upload file đính kèm giống như khi lưu thông tin cá nhân, nếu có upload thì sẽ lưu file đó vào thư mục đính kèm (D:\source\VHR\HTSV_HR\resources\fileUpload\) và lưu đường dẫn của các file đó vào bảng ess_file, 2 bảng HR_EDUCATION_APPLY và ess_file sẽ liên kết với nhau thông qua trường APPLY_NO để lấy ra thông tin về file đính kèm của từng nhân viên. Khi người quản lý duyệt thông tin trình độ chọc vấn của nhân viên đó thì sẽ hiển thị ra những file đính kèm mà nhân viên đó đã upload lên để người quản lý có thể xem xét và đưa ra quyết định duyệt hay không duyệt thông tin trình độ chọc vấn đó. Việc này sẽ giúp cho quá trình quản lý thông tin trình độ chọc vấn của nhân viên được minh bạch hơn và có đầy đủ căn cứ để đưa ra quyết định duyệt hay không duyệt thông tin trình độ chọc vấn đó.

Khi Lưu - saveEduc hãy loại bỏ APPLY_NO của bảng HR_EDUCATION_APPLY.và trường EDUC_NO của bảng HR_EDUCATION_APPLY này sẽ liên kết với trường APPLY_NO của bảng ess_file để lấy ra thông tin về file đính kèm của từng nhân viên. khi thêm mới ở bảng ess_file thì trường FILE_NO sẽ được sinh ra dựa vào ESS_FILE_SEQ.NEXTVAL. Trường APPLY_NO sẽ lấy giá trị từ trường EDUC_NO của bảng HR_EDUCATION_APPLY để liên kết với bảng HR_EDUCATION_APPLY.

Tương tự như chức năng Lưu - savePersonal của viewPersonalInfoForEss.html, thì khi Lưu Thông tin chứng chỉ - saveQual thì cũng thêm vào bảng HR_QUALIFICATION_APPLY với các trường tham khảo từ hình ảnh. Khi thêm mới thì ACTIVITY = 1, trường EDUC_NO tăng lên dựa vào HR_QUALIFICATION_APPLY_SEQ.NEXTVAL. Và cũng có chức năng upload file đính kèm giống như khi lưu thông tin cá nhân, nếu có upload thì sẽ lưu file đó vào thư mục đính kèm (D:\source\VHR\HTSV_HR\resources\fileUpload\) và lưu đường dẫn của các file đó vào bảng ess_file, 2 bảng HR_QUALIFICATION_APPLY và ess_file sẽ liên kết với nhau thông qua trường APPLY_NO để lấy ra thông tin về file đính kèm của từng nhân viên. Khi người quản lý duyệt thông tin thông tin chứng chỉ của nhân viên đó thì sẽ hiển thị ra những file đính kèm mà nhân viên đó đã upload lên để người quản lý có thể xem xét và đưa ra quyết định duyệt hay không duyệt thông tin thông tin chứng chỉ đó. Việc này sẽ giúp cho quá trình quản lý thông tin thông tin chứng chỉ của nhân viên được minh bạch hơn và có đầy đủ căn cứ để đưa ra quyết định duyệt hay không duyệt thông tin thông tin chứng chỉ đó.

Khi Lưu - saveQual hãy loại bỏ APPLY_NO của bảng HR_QUALIFICATION_APPLY.và trường QUAL_NO của bảng HR_QUALIFICATION_APPLY này sẽ liên kết với trường APPLY_NO của bảng ess_file để lấy ra thông tin về file đính kèm của từng nhân viên. khi thêm mới ở bảng ess_file thì trường FILE_NO sẽ được sinh ra dựa vào ESS_FILE_SEQ.NEXTVAL. Trường APPLY_NO sẽ lấy giá trị từ trường QUAL_NO của bảng HR_QUALIFICATION_APPLY để liên kết với bảng HR_QUALIFICATION_APPLY.

Căn cứ ManageEmpPositionInfoList.html, hãy tạo cho tôi file viewEssApplyInfo.html - Chi tiết thay đổi nằm trong module ess/empinfo. Giao diện sẽ hiển thị danh sách các thay đổi thông tin cá nhân của nhân viên đang chờ duyệt (chỉ nhân viên đang đăng nhập), bao gồm các thông tin như Mã nhân viên, Tên nhân viên, Loại thay đổi (thông tin cá nhân, thông tin địa chỉ, thông tin gia đình, người liên hệ khẩn cấp, kinh nghiệm làm việc, trình độ học vấn, thông tin chứng chỉ,...), Trạng thái (đang chờ duyệt - ACTIVITY = 1, đã duyệt - ACTIVITY = 2, đã từ chối - ACTIVITY = 3), Ngày nộp đơn thay đổi,... (Tham khảo hình ảnh) Khi bấm vào từng thay đổi thì sẽ hiển thị chi tiết về thay đổi đó ở bên phải với các tab tương ứng với từng phần thông tin như Thông tin cá nhân, Thông tin địa chỉ, Thông tin gia đình, Người liên hệ khẩn cấp, Kinh nghiệm làm việc, Trình độ học vấn, Thông tin chứng chỉ,... Dữ liệu sẽ được lấy từ các bảng HR_PERSONAL_INFO_APPLY, hr_address_matters_apply, HR_FAMILY_APPLY, hr_emergency_address_apply, HR_WORK_EXPERIENCE_APPLY, HR_EDUCATION_APPLY, HR_QUALIFICATION_APPLY,... kết hợp với bảng ess_file để lấy ra những file đính kèm của từng thay đổi đó.
...
Ở đây hãy thêm cho tôi một nút "Báo cáo nhân sự theo tuần" để khi bấm vào sẽ tải về file excel thống kê nhân viên theo tuần của ngày truy vấn (lấy ngày thứ 2 đến ngày Chủ nhật của tuần của ngày truy vấn) và tuần trước của ngày truy vấn. File excel này sẽ có định dạng như hình ảnh, Số lượng nhân viên sẽ lấy theo bộ phận dựa vào bảng HR_DEPARTMENT với danh sách các bộ phận là điều kiện trường DEPT_LEVEL = 2, khi lấy ra số lượng nhân viên của mỗi bộ phận thì phải lấy cả những nhân viên thuộc bộ phận cọn của bộ phận đó (trường PARENT_DEPT_NO chính là mã bộ phận cha).
